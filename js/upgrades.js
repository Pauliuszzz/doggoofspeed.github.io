...
function arcadeLevel() {
    ...
    switch (localStorage.getItem('ArcadeLevel')) {
      ...
      case '1':
        ...
        break;
      case '2':
        $('#arcadeUpgrade').html('Average Highscore:<br><i>' + Math.round(arcadeInfo[2]) + '/4000</i>')
      ...
      case '5':
        ...
        break;
      case '6':
        $('#arcadeUpgrade').html('Average Highscore:<br><i>' + Math.round(arcadeInfo[2]) + '/5000</i><br>Award: <i><br>New Background</i>')
