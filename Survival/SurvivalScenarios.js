scenarios1 = [
  ...
  },
  {
    ...
    reply1: "You attacked, but he was ready. 20 other kittens jumped you and music started playing:<br>Everybody was kung fu fighting, (ooogh, aaagh).<br>Those CATS were fast as lightning (ooogh, aaagh).<br>It was very very frightening, (ooogh, aaagh).<br>but they fought with expert timing (ooogh, aaagh).",
    answer1: "Try to kill him",
    damage1: 60,
    reply2: "The kitten was quite angry at you for even mentioning milk. Apparently, he was a vegan and milk is a no go for him",
    answer2: "Give him some milk ",
    damage2: 0,
  ...
  },
  {
    ...
    damage1: 100,
    reply2: "Since you wanted to continue walking, that was exactly what you did. Hey, who said dreams couldn't be true!",
    answer2: "Continue walking",
    damage2: 0,
    reply3: "You were lucky, since 5 minutes after running you heard something very loud behind you. Oh? What's that? Is that not the sound of a meteorite? Well, you turned around and saw a huge bear, so now I can assure you that, in fact, was not a flying rock. You played dead, although you almost didn't have to.",
    answer3: "Run for your life in case it is a meteorite",
    damage3: 50,
  },
  {
    //Frog
  ...
  },
  {
    ...
    reply1: "You slept in the open and absolutely fucking nothing happened.",
    answer1: "Sleep in the open",
    damage1: 0,
    ...
    damage2: 75,
    reply3: "You walked through the maze that was this place and got lost. You died of starvation.",
    answer3: "Go deeper",
    damage3: 100,
  },
];
...
scenarios2 = [
  {
    ...
    reply1: "You go there and to stroke it. Sadly the zebra wasn't in a very good mood and kicked you so hard you died.",
  ...
  },
  {
    ...
    damage2: 100,
    reply3: "After 10 minutes of going through the flowers, you are safely back on the road. Now you even have some sleeping pills - poppies.",
    answer3: "Go straight through",
    damage3: 0,
  },
  {
    //Sweet House
  ...
  },
  {
    ...
    damage1: 10,
    reply2: "You try to eat it, but it isn't that tasty. In fact you feel a bit dizzy. That is what happens when plants pick quantity over quality.",
    answer2: "Eat it",
    damage2: 50,
...
scenarios3 = [
  {
    ...
    reply1: "And so you joined the crowd. Everything went well. Only a few days later the catchphrase had become \"All hail mighty Alexander\". This was a cult and you loved it. Why have friends when you have Alexander? There is no reason to live if you don\'t sacrifice your life to Alexander. Alexander. ALEXANDER. ALEXANDER!",
    answer1: "Join them",
    damage1: 100,
    reply2: "The person you asked this question stopped for a second and then proceeded to recite the entirety of Alexander's marketing team's garbage word for word.",
    answer2: "Ask them who this Alexander is",
    damage2: 10,
    reply3: "You told exactly that to one person. Only seconds later the entire crowd looked and you and their leader exclaimed: \"There can be only one!\" Then everyone proceeded to beat you.",
    answer3: "Tell them your name is Alexander",
    damage3: 50,
  },
  {
    //Trading Station
...
scenarios4 = [
  ...
  },
  {
    ...
    reply1: "At first, you tried to bash it with another rock, but nothing happened. Your second idea was to bash it with an even bigger rock but yet again, nothing happened. Your last idea was bashing it with the biggest rock you could find, but even a big rock couldn’t smash it into pieces.",
    answer1: "Try to break the rock",
    damage1: 0,
