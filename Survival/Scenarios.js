scenarios = [
	{
		//Crashed Airplane
		"scenario": "It was a calm evening when you stumbled upon a crashed airplane. You can search the insides (1), try to power it up (2), or use it as a bed (3).",
	...
	{
		//Bob the Kitten
		"scenario": "After walking for 10 minutes you meet Bob the Kitten. You can give him some milk (1), try to kill him (2) or tease him with that cheap laser you bought a few days ago (3).",
		"reply1": "The kitten was quite angry at you for even mentioning milk. Apparently, he was a vegan and milk is a no go for him",
		"score1": 250,
		"death1": 0,
		"reply2": "You attacked, but he was ready. 20 other kittens jumped you and music started playing:<br>Everybody was kung fu fighting, (ooogh, aaagh).<br>Those CATS were fast as lightning (ooogh, aaagh).<br>It was very very frightening, (ooogh, aaagh).<br>but they fought with expert timing (ooogh, aaagh).<br>You were killed by the gang of kittens.",
		"score2": 0,
		"death2": 1,
	...
	{
		//Bandit
		"scenario": "You were calmly walking until a bandit jumped you. You woke up tied up. You can shout for help (1), try to flatter him (2), or invite him to burn some marshmallows above a bonfire and talk about the bandit's mental health problems (3).",
	...
	{
		//Shooting Star
		"scenario": "You were traveling at night when a shooting star appeared. You can stop and think of a wish (1), run for your life in case it is a meteorite (2), or just continue walking (3).",
	...
	{
		//Sleep
		"scenario": "The sun is setting and you want to sleep. You can try to sleep in a tree (1), on a beach (2), or you of course could just stay awake all night (3).",
		"reply1": "Sleeping in a tree isn't the most comfortable thing in the world, but at least it is safe.",
		"score1": 500,
		"death1": 0,
		"reply2": "The waves choke you to death.",
		"score2": 0,
		"death2": 1,
	...
	{
		//Abandoned House
		"scenario": "You find a strange, seemingly abandoned house. You can knock on the door (1), just go through (2), or run in guns blazing (3).",
		"reply1": "You knock on the door, unfortunately wolves hear the knock and attack you. You are as alive as a dead person.",
		"score1": 0,
		"death1": 1,
		"reply2": "The door is locked (for safety reasons of course).",
		"score2": 500,
		"death2": 0,
	...
	{
		//Doll
		"scenario": "You find a doll on the road. You can take it (1), leave it (2), or you can put it aside so no one runs over it (3).",
	...
	{
		//Antaniukas
		"scenario": "While walking you encounter Antaniukas - the car model hobbyist. You can talk to him (1), ask where his parents are (2), or give him a car toy (3).",
	...
	{
		//Paulius the Tiger
		"scenario": "You were walking through a deep forest, when you met Paulius the Tiger. You can shout at him (1), feed him (2), or play with him (3).",
	...
	{
		//Circus
		"scenario": "You were sleeping when you overheard festive music. After going to the source, you found a traveling circus. You can go to the popcorn stand (1), talk to a clown (2), or inspect the zebra (3).",
	...
	},
	{
		...
		"scenario": "While walking through a quite densely populated area you hear a donkey. A donkey who is screeching. You can help it (1), take it for yourself (2), or put another donkey inside (3)",
	...
	{
		//Poppy field
		"scenario": "Out of nowhere a poppy field appeared. It wouldn't be a problem if your path went around it. But no, it went straight through the middle of this mesmerizing field. You can try your luck and go straight through (1), just walk around it (2), or just turn around and go back (3).",
	...
	{	
		//Sweet House
		"scenario": "While walking through a forest you find a rather sweet looking house. It may or may not be made out of candy. You can knock on the door (1), try to eat the house (2), or summon a black hole to remove this house from the face of the earth (3).",
	...
	{	
		...
		"scenario": "You find a house with an interesting inhabitant. That's right! It's Jonas - the soda addict! You can give him a soda bottle filled with dirty water (1), more soda (2), or you could just talk to him about soda.",
